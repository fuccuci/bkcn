...
<div class="container_12">
    ...
    <header>
      ...
      <?php if($this->config->get('gazal_time_text_' . $this->config->get('config_language_id')) != '') { ?>   
      <img src="catalog/view/theme/gazal/image/clock.png" alt="" >&nbsp; <?php echo $this->config->get('gazal_time_text_' . $this->config->get('config_language_id'))?>
      <?php } ?>
      </div>
      ...
      <div class="grid_7">
      	<ul class="top-blocks">
        	<li>
                ...
                <?php } ?>    
                <!--title-->
                <?php if($this->config->get('gazal_firstblock_title_' . $this->config->get('config_language_id')) != '') { ?>
                <h5 class="title-block-top"><?php echo $this->config->get('gazal_firstblock_title_' . $this->config->get('config_language_id'))?></h5><!--custom title-->
                <?php } ?>
                <p><!--custom data-->
                <?php if($this->config->get('gazal_firstblock_desc_' . $this->config->get('config_language_id')) != '') { ?>
                <?php echo $this->config->get('gazal_firstblock_desc_' . $this->config->get('config_language_id'))?>
                <?php } ?>
                </p>
            </li>
            <li>
                ...
                <?php } ?>    
                <!--title-->
                <?php if($this->config->get('gazal_secondblock_title_' . $this->config->get('config_language_id')) != '') { ?>
                <h5 class="title-block-top"><?php echo $this->config->get('gazal_secondblock_title_' . $this->config->get('config_language_id'))?></h5><!--custom title-->
                <?php } ?>
                <p><!--custom data-->
                <?php if($this->config->get('gazal_secondblock_desc_' . $this->config->get('config_language_id')) != '') { ?>
                <?php echo $this->config->get('gazal_secondblock_desc_' . $this->config->get('config_language_id'))?>
                <?php } ?>
                </p>
            </li>
            <li>
                ...
                <?php } ?>    
                <!--title-->
                <?php if($this->config->get('gazal_thirdblock_title_' . $this->config->get('config_language_id')) != '') { ?>
                <h5 class="title-block-top"><?php echo $this->config->get('gazal_thirdblock_title_' . $this->config->get('config_language_id'))?></h5><!--custom title-->
                <?php } ?>
                <p><!--custom data-->
                <?php if($this->config->get('gazal_thirdblock_desc_' . $this->config->get('config_language_id')) != '') { ?>
                <?php echo $this->config->get('gazal_thirdblock_desc_' . $this->config->get('config_language_id'))?>
                <?php } ?>
                </p>
            </li>
            <li>
                ...
                <?php } ?>    
                <!--title-->
                <?php if($this->config->get('gazal_fourthblock_title_' . $this->config->get('config_language_id')) != '') { ?>
                <h5 class="title-block-top"><?php echo $this->config->get('gazal_fourthblock_title_' . $this->config->get('config_language_id'))?></h5><!--custom title-->
                <?php } ?>
                <p><!--custom data-->
                <?php if($this->config->get('gazal_fourthblock_desc_' . $this->config->get('config_language_id')) != '') { ?>
                <?php echo $this->config->get('gazal_fourthblock_desc_' . $this->config->get('config_language_id'))?>
                <?php } ?>
                </p>
            </li>
        </ul>
